...
import com.example.carrental.service.DateTimeInterval;
...
public class Car {
    ...
    public Date getOngoingResvReturnDate() {
        ...
        if (status.equals("доступний")) {
            return null;
        } else {
            if (ongReturnDate.isPresent()) {
                returnDate = ongReturnDate.get();
            } else {
                throw new RuntimeException("Дата повернення не вказана!");
            }
        }
        return returnDate;
    }
    ...
    public String getOngoingResvReturnLocationCity() {
        ...
        if (status.equals("доступний")) {
            ...
            if (ongReturnLocationCity.isPresent()) {
                ...
                throw new RuntimeException("Місто місця повернення не вказано!");
            }
        }
        return returnCity;
    }
